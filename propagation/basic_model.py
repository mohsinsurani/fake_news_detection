...
class ClassficationStats:
    ...
    def get_basic_model_results(self, X_train, X_test, y_train, y_test):
    ...
    def get_classificaton_results_tpnf(self, data_dir, news_source, time_interval, use_cache=False):
        ...
        self.get_basic_model_results(X_train, X_test, y_train, y_test)
...
if __name__ == "__main__":
    ClassficationStats().get_classificaton_results_tpnf("data/features", "politifact", time_interval=None, use_cache=False)
